...
CREATE TABLE auth_user_delete_table (
...
ALTER TABLE auth_user_delete_table OWNER TO postgres;
...
COMMENT ON TABLE auth_user_delete_table IS 'anon: {"mutation_name": "delete"}';

COPY auth_user_delete_table (uuid, email, crypted_password, password_salt, persistence_token, created_at, updated_at, active, first_name, last_name, agency_id, phone, perishable_token, extension, commissioned, region, division, location, last_request_at) FROM stdin;
\.
...
CREATE TABLE auth_user_replica (
  id uuid DEFAULT uuid_generate_v4() NOT NULL,
  email character varying,
  crypted_password character varying,
  password_salt character varyin,
...
ALTER TABLE auth_user_replica OWNER TO postgres;
...
CREATE TABLE auth_users (
  ...
  agency_id uuid,
  original_phone character varying,
  phone character varying,
  perishable_token character varying,
  extension character varying,
  commissioned boolean DEFAULT false,
...
--
-- Name: COLUMN auth_users.middle_name; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN auth_users.middle_name IS 'anon: [{"mutation_name": "middle_name"}]';
...
--
-- Name: COLUMN auth_users.full_name; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN auth_users.full_name IS 'anon: [{"mutation_name": "full_name", "consist_of":["first_name", "middle_name", "last_name"]}]';
...
COMMENT ON COLUMN auth_users.phone IS 'anon: [{"mutation_name": "phone_number", "mutation_kwargs": {"format": "79#########"}, "source_phone": "original_phone"}]';

--
-- Name: COLUMN auth_users.original_phone; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN auth_users.original_phone IS 'anon: [{"mutation_name": "phone_number", "mutation_kwargs": {"format": "7(9##)###-##-##"}}]';
...
COPY auth_users (id, email, crypted_password, password_salt, persistence_token, created_at, updated_at, active, first_name, middle_name, last_name, full_name, agency_id, phone, original_phone, perishable_token, extension, commissioned, region, division, location, last_request_at) FROM stdin;
07750c56-fb37-46e1-b7b6-da530704c056	vsemil1995@example.org	400$8$4c$c11df6facaefc6bc$93a657fb3c6e4cd1fd3255d3bd1edd18ffc4a8092e2616b9e5ca7954b2c52504	v8BMktHnOeokEBTy6As		2016-06-03 18:23:06.25685	2016-06-03 18:23:06.25685	t	Софрон	Виленович	Авдеев	Софрон Виленович Авдеев	\N	79716429809	7(971)642-98-09		\N	f	\N	\N	\N	\N
d489bda7-3212-4026-aef9-879d3242ad0c	dmitri_2016@example.org	400$8$50$5555852e67bf920f$161b41afd99159609151f22fbc4efdccb925244606a87fc635954a71e8f7606f	c5d6v3NS97D3wYkUltFQ		2016-06-03 18:23:06.417694	2016-06-03 18:23:06.417694	t	Игнатий	Кузьминична	Симонов	Игнатий Кузьминична Симонов	\N	79678467062	7(967)846-70-62		\N	f	\N	\N	\N	\N
f7bd4a7f-b63f-41c3-83bd-9683f33bb4b3	savva1978@example.net	400$8$50$8368e20d878ef1b1$b271e3af024b424b7256592439a35d6eb224b4dc769ac9f2fa564b282efb8a47	QOqWQ24CMiRNuPUz8f5		2016-06-03 18:23:06.739671	2016-06-03 18:23:06.739671	t	Варлаам	Харлампович	Белозеров	Варлаам Харлампович Белозеров	\N	79045028085	7(904)502-80-85		\N	f	\N	\N	\N	\N
abe9fd39-f0b3-4ec6-9006-9783fbdade07	chernovaklavdija@example.org	400$8$50$ef1eb813f8d8b99d$2932a9dc75d10f13525e43c29726061d99b4ebdff2e9f9951eb6e2393f36d221	uMYA6c3A7uGoI0aEbJ8R		2016-06-03 18:23:05.797143	2016-06-07 21:53:45.149755	t	Эмилия	Оскаровна	Шилова	Эмилия Оскаровна Шилова	5030cc27-e7a8-4768-b355-20cdcf9efc53	79359821642	7(935)982-16-42		\N	f	\N	\N	\N	2016-06-07 21:53:45.148823
\.
