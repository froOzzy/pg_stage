...
def test_parse_comment_column_with_mutation(
    ...
    assert table_name in obfuscator_object._map_tables
    assert column_name in obfuscator_object._map_tables[table_name]
    assert 'null' == obfuscator_object._map_tables[table_name][column_name]['mutation_name']
...
def test_parse_comment_column_with_invalid_mutation(
    ...
    assert table_name not in obfuscator_object._map_tables
